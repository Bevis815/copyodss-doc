...
新用户需先注册 CopyOdds 账户；已注册用户可通过邮箱验证码或通行密钥（Passkey）登录。登录后系统通常会自动开通交易账户，一般无需额外操作。
...
![注册页面](../.gitbook/assets/regersite_doc.png)

_注册页：填写姓名、邮箱与验证码后完成注册。_
...
![登录页面](../.gitbook/assets/login_doc.png)

_登录页：输入邮箱与验证码，或使用通行密钥快捷登录。_
